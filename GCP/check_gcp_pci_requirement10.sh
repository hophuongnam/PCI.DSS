...
check_required_permissions "logging.logs.list" "logging.sinks.list" "monitoring.alertPolicies.list" || exit 1
...
# Register required permissions for Requirement 10
...
# Main execution
main() {
    info_log "Starting PCI DSS Requirement 10 assessment"
    ...
    local output_file="pci_requirement10_assessment_$(date +%Y%m%d_%H%M%S).html"
