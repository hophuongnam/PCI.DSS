...
add_section "$OUTPUT_FILE" "data-retention" "3.2 - Storage of Account Data"
add_check_result "$OUTPUT_FILE" "info" "Data retention and lifecycle analysis" "<p>Analyzing data retention and lifecycle policies...</p>" ""
